...
function WorkflowView() {
  ...
  this.loadSteps('1');
  this.el.on('click', '.history ol li', this.onClickStep.bind(this));
}
...
WorkflowView.prototype.onClickStep = function (e) {
  ...
  var stepContainer = dom(e.delegateTarget || closest(e.target, 'li'));
  stepContainer.addClass('selected');
...
WorkflowView.prototype.createStepView = function (step) {
  ...
  dom('.history ol').append(stepTemplate.el);
};
